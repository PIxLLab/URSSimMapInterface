...
public class ExtrudedPolygonsFromShapefile extends ApplicationTemplate
{
    ...
    {
        Configuration.setValue(AVKey.INITIAL_LATITUDE, 32.3001619);
        Configuration.setValue(AVKey.INITIAL_LONGITUDE, -106.75295140000003);
        Configuration.setValue(AVKey.INITIAL_ALTITUDE, 1206.00);
